...
def generate_video():
    ...
    rsp = VideoSynthesis.call(
        ...
        prompt='一位蓝色短发的少女，头发是清爽的齐耳直短发，发尾整齐，没有任何卷曲。她有着一双清澈的蓝色大眼睛，眼神温柔而灵动。身穿一件粉红色的连衣裙，裙摆轻盈，带有简单的蕾丝边装饰。白色过膝袜。整体风格为3D动漫风格，色彩明亮，质感像精致的游戏CG。'
               '她微微侧过头，蓝色的眼眸缓缓眨动，目光落在手中一本泛黄的书页上。她将书轻轻抱在胸前，下巴微微低垂，嘴角带着浅浅的、若有所悟的笑意。'
               '背景是高大的橡木书架，书脊在光线下呈现出深浅不一的暖棕色和暗红色，投下细长的阴影。镜头以缓慢的推近速度，从半身景逐渐推向她的面部特写，捕捉她睫毛的细微颤动和眼神中的专注。'
               '氛围安静而治愈，阳光温暖，略带朦胧的梦幻感。电影级浅景深，背景虚化柔和。',
