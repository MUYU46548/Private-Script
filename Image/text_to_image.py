...
if __name__ == "__main__":
    # ===== OC 人物设定示例 =====
    # 在这里调整提示词！这是最大的发挥空间！
    prompt = """角色核心： 动漫角色设定图，平涂风格，一位黑发少女，修剪整齐的姬发式短发。瞳孔呈现发光的红色，眼神犀利且毫无感情，如同精密的机器。
    服装： 极简主义的未来科技装甲，纯白色与黑色拼接的流线型铠甲，贴合身体曲线，没有多余的装饰，体现高级感。
    武器与姿势： 双手反手持握一把异形科幻大刀，刀身由绿色的能量核心和白色金属构成，正对着屏幕，刀尖指地，能量正在汇聚。
    背景： 抽象的数据空间，由无数漂浮的几何碎片和发光的网格线组成，背景深沉黑暗。
    画面氛围： 中心构图，强烈的聚光灯打在人物身上，色彩以纯白、深黑、亮红为主，极度干净利落，充满未来科技的高级感。"""
    ...
    generate_image(
        prompt=prompt,
        size="1024*1024",      # 以wan2.2-t2i-plus为例，宽高均在 [512, 1440] 之间，具体请参阅模型对应文档[reference:5]
        n=4,
