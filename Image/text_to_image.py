...
if __name__ == "__main__":
    # ===== OC 人物设定示例 =====
    # 在这里调整提示词！这是最大的发挥空间！
    prompt = """约15岁的少女，紫色长直发，发梢整齐，紫色的瞳孔，眼神清澈、略带思索，神情安静专注，带有一丝书卷气的柔美。戴着一副细框眼镜，身穿经典款白色水手服，系着深色领巾，搭配格纹短裙和中筒袜，身材纤细，安静地站立在图书馆窗边，手中捧着一本精装书，略微低头看书。
背景是 图书馆的窗边，窗外是明媚的校园景色，阳光透过窗户洒在书架和人物身上，书架背景中隐约可见一些书籍。"""

    # 负向提示词：排除不想要的元素
    negative_prompt = "低质量，模糊，变形，糟糕的构图，水印，文字，扭曲的肢体，扭曲的手，耳环，旗袍，民国装，修身旗袍，高开叉，立领，盘扣，侧开衩，过曝，偏色，杂线，粗糙阴影，3D感，肌肉过度，面容僵硬，多余人像，写实风格，照片，真实感，3D渲染，立体感，景深，散景，真实照片，真人，光影渲染，体积光，Cinema4D，Octane Render"

    # 调用生成
    generate_image(
        prompt=prompt,
        size="1280*720",      # 以wan2.2-t2i-plus为例，宽高均在 [512, 1440] 之间，具体请参阅模型对应文档[reference:5]
        n=4,
